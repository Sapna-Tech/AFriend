...
public class HomeController {
	...
	int most_affected_conf = 0;
	int most_affected_recovered = 0;
	int most_affected_deaths = 0;
	int highestDiff = 0;
...
//		int totalSick = totalReportedCases - totalDeaths - totalRecovered;
		...
		int totalDeaths = gi.getDeaths().getValue();
		int totalRecovered = gi.getRecovered().getValue();
		int totalSick = totalReportedCases - totalRecovered - totalDeaths;
...
//		}
	 ...
	 //Fetching data of Indian States
	   ...
	   Map<String, Integer> india = new LinkedHashMap<>();
		...
		int india_recovered = summary.getDischarged();
		int india_deaths = summary.getDeaths();
       ...
       for(LocationInfo a : information) {
		...
		model.addAttribute("latestNewCases",totalNewCases);
		model.addAttribute("totalDeaths",totalDeaths);
		model.addAttribute("totalRecovered",totalRecovered);
		model.addAttribute("totalSick",totalSick);
		model.addAttribute("highestDiff",highestDiff);
		model.addAttribute("city",city);
		model.addAttribute("deathPercent",deathPercent);
		model.addAttribute("recoveryPercent",recoveryPercent);
		model.addAttribute("most_affected_conf",most_affected_conf);
		model.addAttribute("most_affected_recovered",most_affected_recovered);
		model.addAttribute("most_affected_deaths",most_affected_deaths);
		model.addAttribute("india_conf",india_conf);
		model.addAttribute("india_recovered",india_recovered);
		model.addAttribute("india_deaths",india_deaths);
		model.addAttribute("single_day_India_increase",single_day_India_increase);
		model.addAttribute("china_affected_conf",china_affected_conf);
		model.addAttribute("china_affected_recovered",china_affected_recovered);
		model.addAttribute("china_affected_deaths",china_affected_deaths);
		model.addAttribute("lastUpdate",lastUpdate);
		model.addAttribute("city_info",city_info);
		model.addAttribute("india_indian_nationals",india_indian_nationals);
		model.addAttribute("india_foreign_nationals",india_foreign_nationals);
